...
namespace PreSchool.Application.Services.Settings.Models
{
    ...
    public class SeoSettingModel
    {
        ...
        /// </summary>
        public PageTitleSeoAdjustment PageTitleSeoAdjustmentId { get; set; }
        ...
        /// </summary>
        public WwwRequirement WwwRequirementId { get; set; }
        public string WwwRequirement { get; set; }
